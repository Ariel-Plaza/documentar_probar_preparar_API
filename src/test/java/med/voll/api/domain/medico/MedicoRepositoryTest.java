...
//Reconoce clase como test y da el contexto
@DataJpaTest
//Utilice la misma BD, no reemplazar la bd
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE)
//indicamos el uso del perfil
@ActiveProfiles("test")
...
class MedicoRepositoryTest {
    ...
    @Test
    //podemos poner nombre especifico del test
    @DisplayName("Deberia devolver Null cuando el medico buscado exista pero no esta disponible en esa fecha")
...
//        definir fecha
       ...
       registrarConsulta(medico,paciente,lunesSiguienteALas10,null);
    ...
    private void registrarConsulta(Medico medico, Paciente paciente, LocalDateTime fecha, MotivoCancelamiento motivo) {
        em.persist(new Consulta(null, medico,paciente,fecha, motivo));
    }
